...
CREATE DATABASE IF NOT EXISTS `glvs_phno_master` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE IF NOT EXISTS `glvs_sale_phn_num` (
  ...
  `audit_nm` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `audit_dt` date DEFAULT NULL,
  `user_typ_cd` varchar(50) DEFAULT NULL,
  `user_nm` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
